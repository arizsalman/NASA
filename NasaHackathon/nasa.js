...
//   // NASA API fetch with fallback
//   fetch("https://api.nasa.gov/planetary/apod?api_key=qzgmcOSL0mnZqi7pU5qBkzrgo6QCpuwywat5BuE7")
//     .then(res => {
//       if (!res.ok) throw new Error(`HTTP error! status: ${res.status}`);
//       return res.json();
//     })
//     .then(data => {
//       handleAstronautResponse(normalizedMsg, data);
//     })
//     .catch(err => {
//       console.error(err);
//       // Fallback static picture if API fails
//       const fallbackData = {
//         media_type: "image",
...
//                style="max-width:300px; cursor:pointer; border:2px solid #ccc; border-radius:8px;"/>
//         </a>
//       `;
//       addMessage("astro", imageHTML, true);
//       addMessage("astro", `This is today's Astronomy Picture: "${data.title}"`);
//     } else if (data.media_type === "video") {
//       const videoHTML = `<a href="${data.url}" target="_blank">Watch the video here 🎥</a>`;
//       addMessage("astro", videoHTML, true);
//       addMessage("astro", `This is today's Astronomy video: "${data.title}"`);
//     }
//   }
//   // Show title
//   else if (msg.includes("title")) {
//     addMessage("astro", `Today's picture is titled: "${data.title}"`);
//   }
//   // Show explanation
...
//   // Default fallback
//   else {
//     addMessage("astro", "I can answer about the picture, its title, or explain it. Try asking: 'Show me picture', 'What is the title?', or 'Explain'.");
//   }
// }
